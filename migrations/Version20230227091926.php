 ...
 */
final class Version20230227091926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE devis (id INT NOT NULL, membre_id INT DEFAULT NULL, date_val DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles TEXT DEFAULT NULL, password VARCHAR(255) NOT NULL, is_verified BOOLEAN NOT NULL, token VARCHAR(255) DEFAULT NULL, date_token TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, user_token VARCHAR(255) DEFAULT NULL, user_date_token TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
